<!--
 * @Descripttion: 带快速选择时间按钮的时间选择组件
 * @version: 1.0.0
 * @Author: YangJiyong
 * @Date: 2020-05-28 10:06:51
 * @LastEditors: YangJiyong
 * @LastEditTime: 2021-01-06 17:26:47
-->
<template>
  <div class="search-item">
    ...
    <div class="quick-btn-group">
      ...
      <el-button
        size="mini"
        plain
        :class="{ 'current-btn': currentBtn === 'seven' }"
        @click="quickHandle('seven')"
        v-if="quickBtn.includes('seven')"
        >最近7天</el-button
      >
      <el-button
        size="mini"
  ...
  methods: {
    ...
    quickHandle(type = 'day') {
      ...
      if (type === 'day') {
        ...
        now.toLocaleDateString()
        start = new Date(now.toLocaleDateString() + ' 00:00:00').valueOf()
        end = new Date(new Date().toLocaleDateString() + ' 23:59:59').valueOf()
      } else if (type === 'week') {
        //   本周
