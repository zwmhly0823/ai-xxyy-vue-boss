 ...
 * @LastEditors: panjian
 * @LastEditTime: 2020-04-07 20:12:29
 -->
<template>
  <div>
    <!-- <svg
    ...
    <el-popover placement="boottom" width="300" trigger="click">
      <!-- <el-button slot="reference">筛选</el-button> -->
      <el-button slot="reference" @click="visible = !visible">筛选</el-button>
      ...
      <el-checkbox-group
        ...
        @change="handleCheckedCitiesChange"
      >
        <el-checkbox v-for="friend in friends" :label="friend" :key="friend">{{
          friend
        }}</el-checkbox>
      </el-checkbox-group>
      <p>完课情况</p>
