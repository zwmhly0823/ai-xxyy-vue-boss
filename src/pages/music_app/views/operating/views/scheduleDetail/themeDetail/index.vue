 ...
 * @LastEditTime: 2021-03-22 17:32:14
 -->
<template>
  <div class="">
    <div class="head-info">
    ...
    <el-tabs type="border-card">
      <el-tab-pane label="招生详情-销售">
        <div class="search-container">
          <table-search @change="searchChange" :showTheme="true"></table-search>
        </div>
        <theme-table :paramsInfo="params"></theme-table>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    searchChange(search) {
      const { department = [], groupSell = '', mealIds = '' } = search
      Object.assign(this.params, {
