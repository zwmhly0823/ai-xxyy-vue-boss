 ...
 * @LastEditTime: 2021-01-13 20:34:21
-->
<template>
  <div class="drawer-main">
    <div class="drawer-con">
      ...
      <!-- 扣款金额明细 -->
      <!-- <div class="drawer-line">
        <p class="line-title">扣款金额明细</p>
        <el-table
          :data="orderDel"
          style="width: 95%;border: 1px solid #d7d7e0;"
          :header-cell-style="{ background: '#F0F9FD' }"
        >
          <el-table-column prop="regTypeDesc" width="100" label="课程扣款金额">
          </el-table-column>
          <el-table-column prop="title" label="优惠券扣款金额">
          </el-table-column>
          <el-table-column prop="totalAmount" label="物流扣款金额">
          </el-table-column>
          <el-table-column prop="discountAmount" label="赠品扣款金额">
          </el-table-column>
          <el-table-column prop="tradeTypeDesc" label="赠品扣费明细">
          </el-table-column>
          <el-table-column prop="amount" label="补偿扣款金额"></el-table-column>
          <el-table-column prop="periodAlready" label="退款金额">
          </el-table-column>
        </el-table>
      </div> -->
      <div class="drawer-line">
