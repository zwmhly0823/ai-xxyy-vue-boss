  ...
  <div class="intent-dialog-box">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="small" @click="showIntentDialog = false">
          取 消
        </el-button>
...
export default {
  ...
  watch: {
    remarks(val) {
      ...
      //   val && val.userIntention && val.userIntention.describe
      this.$set(
        this.formData,
        'textarea',
        val && val.userIntention && val.userIntention.describe
      )
      switch (val && val.userIntention && val.userIntention.type) {
        case '3':
          radioName = '高'
          break
        case '2':
      ...
      this.formData.radio = radioName
      this.remarks_son = val
    }
  },
  methods: {
    showDialog(data) {
