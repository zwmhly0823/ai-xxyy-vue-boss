 ...
 * @LastEditTime: 2020-06-12 18:55:31
 -->
<template>
            ...
            >
              ...
              >
                <template slot="header">
                  <div
                    @click="onSortSystemCount('system_order_count')"
                  ...
                  >
                    ...
                    <div class="sort-icon-arrow">
                      <i
                        ...
                        :class="{
                          active:
                            sortKeys['system_order_count'] == 'asc' &&
              ...
              >
                <template slot="header">
                  <div
                    @click="onSortSystemCount('order_conversion_rate')"
                    class="sort-operate-box"
                  >
                    <span>订单转化率</span>
                    <div class="sort-icon-arrow">
                      <i
                        ...
                        :class="{
                          active:
                            sortKeys['order_conversion_rate'] == 'asc' &&
                            sortActive == 'order_conversion_rate'
                        }"
                      ></i>
                      <i
                        class="el-icon-caret-bottom bottom"
                ...
                <template slot-scope="scope">
                  <span>{{ `${scope.row.order_conversion_rate}%` }}</span>
                </template>
              </el-table-column>
              <el-table-column
                label="待加好友"
