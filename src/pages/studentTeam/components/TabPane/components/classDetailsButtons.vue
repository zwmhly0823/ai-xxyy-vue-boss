...
<script>
import finishclass from '@/pages/studentTeam/components/TabPane/FinishClass.vue'
import exhibition from '@/pages/studentTeam/components/TabPane/Exhibition.vue'
