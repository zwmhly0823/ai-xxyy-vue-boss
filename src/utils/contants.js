export default {
  ...
  OSS_IMG_BASE_URL_ONLINE: 'https://ai-xxyy-backend-online.oss-cn-hangzhou.aliyuncs.com',
  ...
  OSS_IMG_DEMO:
    'https://s1.meixiu.mobi/image/border.png?x-oss-process=image/resize,w_200'
}
